...
> _Đáp án:_ **22 chunks**
>
> _(Lưu ý: tuỳ implementation cụ thể kết quả có thể là 22 hoặc 23. Công thức tổng quát: `ceil((N - overlap) / step)` với N=10000 → 23; nhưng theo code `FixedSizeChunker` trong lab dừng khi `start + chunk_size >= len(text)` → 22 chunks.)_
